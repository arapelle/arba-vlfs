...
class ArbaVlfsRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "vlfs"
    name = f"{project_namespace}-{project_base_name}"
    package_type = "library"

    # Optional metadata
    description = "A C++ library providing tools to manipulate virtual filesystem paths."
    url = "https://github.com/arapelle/arba-vlfs"
    homepage = "https://github.com/arapelle/arba-vlfs"
    topics = ("virtual-filesystem", "virtual-path", "filesystem")
    license = "MIT"
